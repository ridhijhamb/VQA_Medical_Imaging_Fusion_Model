...
class ModelArguments:
    ...
    ckp: Optional[str] = field(default="src/MedVInT_TD/Results/VQA_lora_PMC_LLaMA_PMCCLIP/blank/checkpoint-1382")
    ...
    visual_model_path: Optional[str] = field(default='src\MedVInT_TD\img_checkpoint\checkpoint.pt')
...
class DataArguments:
    ...
    Test_csv_path: str = field(default='C:/Users/joyrb/Documents/GitHub/ESE546-HW/Project/PMC-VQA/PMC-VQA/test.csv', metadata={"help": "Path to the training data."})
    tokenizer_path: str = field(default="hf-internal-testing/llama-tokenizer", metadata={"help": "Path to the training data."})
